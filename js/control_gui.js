...
function showInfo(){ 
    ...
    if(infoLevel===0 && infovalue==999 ){$("#infotext").load("info/info_gui_eth.html");}
    else if(infoLevel===0){$("#infotext").load("info/info_gui.html");}
    //else if(infoLevel===5){$("#infotext").load("info/info_gui_eth.html");}
